...
@section('content')
    <div style="height: 60px;background-color: rgb(240,140,35);color: white">
    ...
    <div class="container" style="background-color: rgb(105,17,42)">
        ...
        <textarea name="area" style="width: 330px;margin-top: 30px;height: 270px;" placeholder="Descripcion"></textarea>
        ...
        <div style="margin-top: 15px;padding-bottom: 30px;">
            <span style="color: white;"><a href="#" id="add" style="color: white;"><img src="/icon/icono_adjuntar-01.png" style="width: 10%;"><span style="margin-left: 5px;">Adjuntar Archivo </span></a><button class="pull-right" style="background-color: rgb(240,140,35);border-color: rgb(240,140,35);color: white;" id="next">A&ntilde;adir</button></span>
        </div>
        <script>
            $("#add").click(function(){
                $("#next").html('publicar');
